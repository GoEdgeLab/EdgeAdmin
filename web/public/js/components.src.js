...
window.WAF_RULE_OPERATORS = [{"name":"数值大于","code":"gt","description":"使用数值对比大于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"数值大于等于","code":"gte","description":"使用数值对比大于等于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"数值小于","code":"lt","description":"使用数值对比小于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"数值小于等于","code":"lte","description":"使用数值对比小于等于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"数值等于","code":"eq","description":"使用数值对比等于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"数值不等于","code":"neq","description":"使用数值对比不等于，对比值需要是一个数字","caseInsensitive":"none"},{"name":"字符串等于","code":"eq string","description":"使用字符串对比等于","caseInsensitive":"no"},{"name":"字符串不等于","code":"neq string","description":"使用字符串对比不等于","caseInsensitive":"no"},{"name":"正则匹配","code":"match","description":"使用正则表达式匹配，在头部使用(?i)表示不区分大小写，\u003ca href=\"https://goedge.cn/docs/Appendix/Regexp/Index.md\" target=\"_blank\"\u003e正则表达式语法 \u0026raquo;\u003c/a\u003e","caseInsensitive":"yes"},{"name":"正则不匹配","code":"not match","description":"使用正则表达式不匹配，在头部使用(?i)表示不区分大小写，\u003ca href=\"https://goedge.cn/docs/Appendix/Regexp/Index.md\" target=\"_blank\"\u003e正则表达式语法 \u0026raquo;\u003c/a\u003e","caseInsensitive":"yes"},{"name":"包含字符串","code":"contains","description":"包含某个字符串，比如Hello World包含了World","caseInsensitive":"no"},{"name":"不包含字符串","code":"not contains","description":"不包含某个字符串，比如Hello字符串中不包含Hi","caseInsensitive":"no"},{"name":"包含任一字符串","code":"containsAny","description":"包含字符串列表中的任意一个，比如/hello/world包含/hello和/hi中的/hello，每行一个字符串","caseInsensitive":"no"},{"name":"包含所有字符串","code":"containsAll","description":"包含字符串列表中的所有字符串，比如/hello/world必须包含/hello和/world，每行一个字符串","caseInsensitive":"no"},{"name":"包含前缀","code":"prefix","description":"包含字符串前缀部分，比如/hello前缀会匹配/hello, /hello/world等","caseInsensitive":"no"},{"name":"包含后缀","code":"suffix","description":"包含字符串后缀部分，比如/hello后缀会匹配/hello, /hi/hello等","caseInsensitive":"no"},{"name":"包含二进制数据","code":"contains binary","description":"包含一组二进制数据","caseInsensitive":"no"},{"name":"不包含二进制数据","code":"not contains binary","description":"不包含一组二进制数据","caseInsensitive":"no"},{"name":"包含索引","code":"has key","description":"对于一组数据拥有某个键值或者索引","caseInsensitive":"no"},{"name":"版本号大于","code":"version gt","description":"对比版本号大于","caseInsensitive":"no"},{"name":"版本号小于","code":"version lt","description":"对比版本号小于","caseInsensitive":"no"},{"name":"版本号范围","code":"version range","description":"判断版本号在某个范围内，格式为version1,version2","caseInsensitive":"no"},{"name":"IP等于","code":"eq ip","description":"将参数转换为IP进行对比","caseInsensitive":"no"},{"name":"IP大于","code":"gt ip","description":"将参数转换为IP进行对比","caseInsensitive":"no"},{"name":"IP大于等于","code":"gte ip","description":"将参数转换为IP进行对比","caseInsensitive":"no"},{"name":"IP小于","code":"lt ip","description":"将参数转换为IP进行对比","caseInsensitive":"no"},{"name":"IP小于等于","code":"lte ip","description":"将参数转换为IP进行对比","caseInsensitive":"no"},{"name":"IP范围","code":"ip range","description":"IP在某个范围之内，范围格式可以是英文逗号分隔的\u003ccode-label\u003e开始IP,结束IP\u003c/code-label\u003e，比如\u003ccode-label\u003e192.168.1.100,192.168.2.200\u003c/code-label\u003e；或者CIDR格式的ip/bits，比如\u003ccode-label\u003e192.168.2.1/24\u003c/code-label\u003e；或者单个IP。可以填写多行，每行一个IP范围。","caseInsensitive":"no"},{"name":"不在IP范围","code":"not ip range","description":"IP不在某个范围之内，范围格式可以是英文逗号分隔的\u003ccode-label\u003e开始IP,结束IP\u003c/code-label\u003e，比如\u003ccode-label\u003e192.168.1.100,192.168.2.200\u003c/code-label\u003e；或者CIDR格式的ip/bits，比如\u003ccode-label\u003e192.168.2.1/24\u003c/code-label\u003e；或者单个IP。可以填写多行，每行一个IP范围。","caseInsensitive":"no"},{"name":"IP取模10","code":"ip mod 10","description":"对IP参数值取模，除数为10，对比值为余数","caseInsensitive":"no"},{"name":"IP取模100","code":"ip mod 100","description":"对IP参数值取模，除数为100，对比值为余数","caseInsensitive":"no"},{"name":"IP取模","code":"ip mod","description":"对IP参数值取模，对比值格式为：除数,余数，比如10,1","caseInsensitive":"no"}]
